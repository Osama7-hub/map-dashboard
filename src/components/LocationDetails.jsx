import {
  ...
  export default function LocationDetails({ selectedLocation }) {
    if (!selectedLocation) {
      return (
        <div className="col-span-12 md:col-span-2 bg-[#FAFBFD] p-6 border-gray-200 border-l overflow-y-auto">
    ...
    return (
      <div className="space-y-6 col-span-12 md:col-span-2 bg-[#FAFBFD] p-6 border-gray-200 border-l overflow-y-auto text-gray-700">
